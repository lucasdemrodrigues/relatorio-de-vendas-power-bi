...
| :---: | :---: |
| Apresenta receita, lucro e unidades vendidas do produto selecionado. | Compara os preços bruto e líquido por unidade e informa a taxa e o valor total dos descontos. |
...
* 🌍 **Diferenças entre receita e lucro por país:** a receita apresenta distribuição relativamente equilibrada entre os cinco países, variando de aproximadamente $20 milhões a $25 milhões. Os Estados Unidos lideram em receita, com $25,03 milhões, enquanto França e Alemanha registram os maiores lucros, com $3,78 milhões e $3,68 milhões, respectivamente. Esse contraste mostra que os países com maiores vendas não são necessariamente os mais rentáveis, tornando relevante comparar seus custos, descontos e composição das vendas por produto.
* 🏆 **Liderança e descontos do produto Paseo:** o produto `PASEO` lidera a geração de receita, com $33,01 milhões, mas também concentra o maior valor de descontos, totalizando $2,60 milhões. Ainda assim, apresenta margem de 14,53%, ligeiramente superior à margem consolidada de 14,23% e a terceira maior entre os produtos, indicando que seu desempenho em receita é acompanhado por uma rentabilidade comparativamente sólida. A relação entre taxa de desconto e volume vendido, no entanto, exigiria uma análise mais aprofundada para verificar se preços menores estão associados ao aumento da demanda.
...
- Conferência dos tipos de dados das colunas;
